...
const IA_TABS: IATab[] = [
  ...
  },
  {
    ...
    items: [
      { label: "챕터 선택", path: "/chapter" },
      { label: "지문형 객관식 퀴즈 (A/B/C UI UX테스트)", path: "/quiz/choice" },
      { label: "지문형 OX 퀴즈 (A/B/C UI UX테스트)", path: "/quiz/ox" },
      { label: "대화형 객관식 퀴즈", path: "/quiz/conversation" },
      { label: "퀴즈 결과", path: "/quiz/result" },
      { label: "미정" },
    ],
  },
  {
