...
export const MOCK_CHOICE_QUESTION_SET: ChoiceQuestionSet = {
  ...
  questions: [
    ...
    // --- 2부: 실전 모의고사 (퀴즈 모드) ---
    {
      ...
      imageAlt: "강아지 일러스트",
      question: "Q1. 아저씨의 말만 믿을 수 없는 멍멍이! 이 집의 '진짜 주인'과 '빚'을 확인하기 위해 당당하게 떼어달라고 요구해야 할 서류는?",
      choices: [
    ...
    },
    {
      ...
      question: "Q2. 집의 겉모습이 적혀 있는 서류의 이 부분은 뭐라고 부를까요?",
      choices: ["표제부", "갑구", "을구"],
      correctIndex: 0,
    ...
    },
    {
      ...
      imageAlt: "자세히 바라보는 개",
      question: "Q3. 소유권 확인을 위해 서류의 어느 부분을 뚫어져라 살펴봐야 할까요?",
      choices: ["표제부", "갑구", "을구"],
      correctIndex: 1,
    ...
    },
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=400&q=80",
      imageAlt: "경고",
      question: "Q4. 이때 불독 아저씨의 말을 들은 멍멍이의 올바른 행동은?",
      choices: [
    ...
    },
    {
      ...
      imageAlt: "집 안 문스프링",
      question: "Q5. 신탁이라고 적힌 집, 불독 아저씨의 말만 믿고 덜컥 계약해도 될까요?",
    ...
    },
    {
      ...
      imageAlt: "계산기와 돈",
      question: "Q6. 이 집에 은행 대출이 얼마나 있는지 확인하려면 서류의 어디를 봐야 할까요?",
      choices: ["표제부", "갑구", "을구"],
      correctIndex: 2,
    ...
    },
    {
      ...
      imageAlt: "생각하는 개",
      question: "Q7. 멍멍이의 생각 중 가장 위험한 착각은 무엇일까요?",
      choices: [
    ...
    },
    {
      ...
      imageAlt: "바스락거리는 종이",
      question: "Q8. 영수증을 본 상황에서 가장 똑똑한 멍멍이의 말은?",
      choices: [
    ...
    },
    {
      ...
      imageAlt: "열쇠 모양 액세서리",
      question: "Q9. 보통 전체 전세 보증금의 몇 %를 계약금으로 낼까요?",
      choices: [
        "1% (만 원만 낼게요!)",
        "5~10% (국룰의 시작!)",
        "50% (반은 줘야 내 집이지!)",
    ...
    },
    {
      ...
      imageAlt: "퍼그 강아지",
      question: "Q10. 멍멍이가 퍼그 아저씨에게 꼭 확인해야 하는 '대리인 필수 서류' 두 가지는?",
      choices: [
        "가족관계증명서, 불독 아저씨의 셀카",
        "위임장, 불독 아저씨의 인감증명서",
        "건축물대장, 토지대장",
    ...
    },
    {
      ...
      imageAlt: "돈 뭉치",
      question: "Q11. 계약서 맨 밑 '특약사항'에 꼭 적어달라고 해야 하는 '마법의 문장'은?",
      choices: [
    ...
    },
    {
      ...
      imageAlt: "모바일 폰 이체",
      question: "Q12. 멍멍이는 귀찮은데 그냥 퍼그 아저씨 통장으로 돈을 보내도 될까요?",
