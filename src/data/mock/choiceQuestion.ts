...
export const MOCK_CHOICE_QUESTION_SET: ChoiceQuestionSet = {
  ...
  questions: [
    ...
    // ────────────────────────────────────────────────────────
    {
      ...
      passageMode: "text",
      choiceMode: "multiple",
      passage: "[Scene 1: 첫 만남]\n부푼 꿈을 안고 '불독 부동산' 문을 연 멍멍이. 불독 중개사 아저씨가 시세 반값짜리 집을 보여주며 당장 계약하자고 재촉합니다.",
      ...
      imageAlt: "강아지 일러스트",
      question: "아저씨의 말만 믿을 수 없는 멍멍이! 이 집의 진짜 주인과 빚을 확인하기 위해 당당하게 떼어달라고 요구해야 할 서류는?",
      choices: [
        "건축물대장",
        "주민등록등본",
        "등기사항전부증명서(등기부등본)",
      ...
      correctIndex: 2,
      explanation: "부동산 계약의 기본은 '등기부등본' 확인부터 시작합니다. 중개사의 말보다 공적인 서류를 먼저 믿으세요!",
    },
    {
      questionNumber: 7,
      type: "quiz",
      ...
      correctIndex: 1,
      explanation: "갑구에는 소유권(진짜 주인)과 가압류 같은 권리 위험이, 을구에는 은행 대출 같은 빚(소유권 이외의 권리)이 적혀 있습니다.",
    },

    // ────────────────────────────────────────────────────────
    // 3단계: 서류 기반 문제 풀기 (type: "quiz", passageMode: "document") - Q8, Q9, Q10
    // ────────────────────────────────────────────────────────
    ...
    // ────────────────────────────────────────────────────────
    // 4단계: 상황형 문제 풀기 (type: "quiz", passageMode: "conversation") - Q11 ~ Q14
    // ────────────────────────────────────────────────────────
    {
      questionNumber: 11,
      type: "quiz",
